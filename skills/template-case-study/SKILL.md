...
description: "Esqueleto interno do output do comando /hormozi-gtm:case-study. Carregado pelo comando, não para uso direto."
---

# Template — case-study.md

Esqueleto canônico do output do comando `/hormozi-gtm:case-study`. O comando carrega esta skill e preenche o esqueleto abaixo com os inputs do usuário. Reproduza a estrutura exata: frontmatter + todas as seções + placeholders `{{...}}`.
